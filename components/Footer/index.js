        ...
        <div className="row g-5">
          <div className="col-lg-3 col-md-6">
            <h1 className="fw-bold text-primary mb-4">
              F<span className="text-secondary">oo</span>ds
            </h1>
          ...
          <div className="col-lg-3 col-md-6">
            ...
            <ul>
              <li>Gọi mua: 090 123 4567</li>
              <li>Kĩ thuật: 039 123 4567</li>
              <li>Khiếu nại: 079 123 4567</li>
              <li>Bảo hành: 093 123 4567</li>
            </ul>
          </div>
        </div>
      </div>
